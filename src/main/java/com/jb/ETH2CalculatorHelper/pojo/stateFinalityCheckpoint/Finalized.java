...
public class Finalized implements Serializable
{
    ...
    @JsonProperty("root")
    private String root;
    private final static long serialVersionUID = -2904922998583152035L;
    ...
    public String toString() {
        ...
        sb.append(Finalized.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("epoch");
        sb.append('=');
